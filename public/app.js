...
function cacheElements() {
  [
    ...
    'downloadMessage', 'downloadCount', 'uniqueCount', 'gamePlatform', 'gameVersion', 'gameFile',
...
async function loadStats() {
  try {
    ...
    els.uniqueCount.textContent = '—';
  }
}

function renderStats(data) {
  els.downloadCount.textContent = formatNumber(data?.totalDownloads);
  els.uniqueCount.textContent = formatNumber(data?.usuariosUnicos);
}
